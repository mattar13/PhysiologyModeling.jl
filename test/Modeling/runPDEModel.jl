...
using .PhysiologyModeling.DiffEqCallbacks
...
domain_x = (xmin, xmax) = (0.0, 0.250) #This is a simulation for a retina 5mm in diameter
domain_y = (ymin, ymax) = (0.0, 0.250)
...
GABA_dist_func(p1, p2) = RING_CIRC(p1, p2; density = 0.01) * bias_func(p1, p2)
...
save_fn1 = "Modeling/Results/2024_02_12_WTCell1_MODEL.png"
